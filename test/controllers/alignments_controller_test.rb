...
class AlignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alignment" do
    assert_difference('Alignment.count') do
      post alignments_url, params: { alignment: { descr: @alignment.descr, name: @alignment.name, val: @alignment.val } }
    end
  ...
  test "should update alignment" do
    patch alignment_url(@alignment), params: { alignment: { descr: @alignment.descr, name: @alignment.name, val: @alignment.val } }
