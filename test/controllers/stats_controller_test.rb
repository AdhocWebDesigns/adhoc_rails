...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { cha: @stat.cha, con: @stat.con, dex: @stat.dex, int: @stat.int, str: @stat.str, user_id: @stat.user_id, wis: @stat.wis } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { cha: @stat.cha, con: @stat.con, dex: @stat.dex, int: @stat.int, str: @stat.str, user_id: @stat.user_id, wis: @stat.wis } }
