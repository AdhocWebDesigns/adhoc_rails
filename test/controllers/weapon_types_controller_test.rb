...
class WeaponTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon_type" do
    assert_difference('WeaponType.count') do
      post weapon_types_url, params: { weapon_type: { desc: @weapon_type.desc, name: @weapon_type.name } }
    end
  ...
  test "should update weapon_type" do
    patch weapon_type_url(@weapon_type), params: { weapon_type: { desc: @weapon_type.desc, name: @weapon_type.name } }
