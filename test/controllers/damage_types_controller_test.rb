...
class DamageTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create damage_type" do
    assert_difference('DamageType.count') do
      post damage_types_url, params: { damage_type: { mod: @damage_type.mod, name: @damage_type.name } }
    end
  ...
  test "should update damage_type" do
    patch damage_type_url(@damage_type), params: { damage_type: { mod: @damage_type.mod, name: @damage_type.name } }
