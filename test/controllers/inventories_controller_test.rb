...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { items_id: @inventory.items_id, user_id: @inventory.user_id } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { items_id: @inventory.items_id, user_id: @inventory.user_id } }
